        ...
        <div class="navbar-content scroll-div ">
            ...
            <div class="">
                <div class="main-menu-header">
                    <img class="img-radius" src="assets/images/user/user/<?= $_SESSION['foto']; ?>"
                ...
                <div class="collapse" id="nav-user-link">
                    <ul class="list-unstyled">
                        ...
                        <li class="list-group-item"><a href="../login/logout.php"><i
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="?page=kategori/index" class="nav-link "><span class="pcoded-micon"><i
                                class="feather icon-list"></i></span><span class="pcoded-mtext">Kategori</span></a>
                </li>
                <li class="nav-item">
                    <a href="?page=produk/index" class="nav-link "><span class="pcoded-micon"><i
                                class="feather icon-folder"></i></span><span class="pcoded-mtext">Produk</span></a>
                </li>
                <li class="nav-item">
                    <a href="?page=pesanan/index" class="nav-link "><span class="pcoded-micon"><i
                ...
                <li class="nav-item">
                    <a href="?page=user/index" class="nav-link "><span class="pcoded-micon"><i
            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img src="assets/images/user/user/<?= $_SESSION['foto']; ?>" class="img-radius"
                                alt="User-Profile-Image">
                            <span><?= $_SESSION['nama_lengkap']; ?></span>
                            <a href="?page=login/logout" class="dud-logout" title="Logout">
